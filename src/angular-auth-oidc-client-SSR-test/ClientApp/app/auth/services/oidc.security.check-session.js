...
var OidcSecurityCheckSession = (function () {
    ...
    OidcSecurityCheckSession.prototype.init = function () {
        var _this = this;
        var exists = window.parent.document.getElementById('myiFrameForCheckSession');
        if (!exists) {
    ...
    OidcSecurityCheckSession.prototype.pollServerSession = function (clientId) {
        ...
        var subscription = source.subscribe(function () {
            ...
            var session_state = _this.oidcSecurityCommon.retrieve(_this.oidcSecurityCommon.storage_session_state);
